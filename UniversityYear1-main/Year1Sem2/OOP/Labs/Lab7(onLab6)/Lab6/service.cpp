...
Dynamic_array<Tape>* Service::list_function()
{
...
Dynamic_array<Tape>* Service::list_my_list()
{
	return this->recordings->get_my_list_for_listing();
}

Dynamic_array<Tape>* Service::list_by_section_access(string section,int access_count)
{
