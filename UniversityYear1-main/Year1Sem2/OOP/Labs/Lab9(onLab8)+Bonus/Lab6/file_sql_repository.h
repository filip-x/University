...
typedef tm Date;
class Sql_Repository :public Repository_Inherit
{
public:

	Sql_Repository(std::string path_to_file);
	~Sql_Repository();
	...
	//void repository_add_mylist(Tape* new_element_to_add_into_my_list)override; //for lab 8 only
